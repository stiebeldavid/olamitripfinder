  ...
  const FilterSection = () => <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-6">
      <div className="bg-white p-6 rounded-lg shadow-sm space-y-6 md:sticky md:top-20 md:self-start">
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            <label className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              <Checkbox id="mixed" checked={filters.gender.mixed} onCheckedChange={checked => setFilters(prev => ({
              ...prev,
              gender: {
                ...prev.gender,
                mixed: checked === true
            ...
            <label className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              <Checkbox id="male" checked={filters.gender.male} onCheckedChange={checked => setFilters(prev => ({
              ...prev,
              gender: {
                ...prev.gender,
                male: checked === true
            ...
            <label className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              <Checkbox id="female" checked={filters.gender.female} onCheckedChange={checked => setFilters(prev => ({
              ...prev,
              gender: {
                ...prev.gender,
                female: checked === true
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            <label className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              <Checkbox id="united_states" checked={filters.location.united_states} onCheckedChange={checked => setFilters(prev => ({
              ...prev,
              location: {
                ...prev.location,
                united_states: checked === true
              }
            }))} />
              <span className="text-sm">United States</span>
            </label>
            <label className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              <Checkbox id="international" checked={filters.location.international} onCheckedChange={checked => setFilters(prev => ({
              ...prev,
              location: {
                ...prev.location,
      ...
      <div>
        {isLoading ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-4">
            {[1, 2, 3].map(i => <div key={i} className="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          </div> : filteredTrips && filteredTrips.length > 0 ? Object.entries(groupTripsByMonth(filteredTrips)).map(([month, monthTrips]) => <div key={month} className="mt-8 first:mt-0">
              <div className="mb-6">
  ...
  return <div className="min-h-screen bg-gray-50 pb-14">
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 h-14">
          <div className="h-8 flex items-center">
            <img src="/lovable-uploads/c0777c81-bd25-4b7f-8afb-3885843e912b.png" alt="Olami Trip Finder" className="h-full w-auto" />
          </div>
          <Button size="sm" className="flex items-center gap-1 ml-4" onClick={() => setShowContactInfo(true)}>
            Contact Us
          </Button>
        </div>
      </nav>
      ...
      <div className="relative">
        <div className="absolute inset-0">
          <img src="/lovable-uploads/16666368-d298-47be-9ef8-c608163578c5.png" alt="Students enjoying their trip" className="w-full h-full object-cover" />
        ...
        <div className="relative pt-24 pb-16 px-4 md:pt-32 md:pb-24">
          <div className="max-w-7xl mx-auto">
            ...
            <Button size="lg" className="bg-[#FF6B00] hover:bg-[#FF6B00]/90 text-white font-founders" onClick={() => {
      ...
      <div id="search-section" className="mt-8 px-4 py-3 max-w-7xl mx-auto">
        <div className="relative">
          <input type="text" placeholder="Search trips..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="w-full h-10 pl-10 pr-4 bg-white rounded-full border-none shadow-sm text-sm font-founders" />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" onClick={(e) => {
          ...
          <div className="bg-white rounded-lg w-full md:w-1/2 max-h-[90vh] overflow-hidden">
            <div className="sticky top-0 bg-white border-b flex items-center justify-between p-4 z-10">
              ...
              <Button size="icon" variant="ghost" onClick={() => setSelectedTrip(null)}>
                <X className="w-5 h-5" />
              </Button>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2 pt-4">
                    {selectedTrip.websiteUrl && <Button className="w-full" onClick={() => window.open(selectedTrip.websiteUrl, "_blank", "noopener noreferrer")}>Go to Trip Website</Button>}
                  ...
                  window.location.href = `mailto:${selectedTrip.organizer.contact}?subject=${subject}&body=${body}`;
                    ...
                    <div className="space-y-2">
                      ...
                      window.open(`https://wa.me/?text=${shareText}`, "_blank", "noopener noreferrer");
                          ...
                          <img src="/lovable-uploads/d50e0415-da2b-47dc-80c7-2f4b06069346.png" alt="Share on WhatsApp" className="w-4 h-4" />
                        </Button>
                        <Button variant="outline" size="icon" onClick={() => {
                      const tripUrl = `${window.location.origin}/trip/${selectedTrip.trip_id}`;
                      window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(tripUrl)}`, "_blank", "noopener noreferrer");
                    }}>
                          <img src="/lovable-uploads/823bbda7-ae49-431f-a322-06cb6a1e17e5.png" alt="Share on Facebook" className="w-4 h-4" />
                        </Button>
                      </div>
                    </div>
                  </div>
      ...
      {showContactInfo && <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="flex justify-between items-start mb-4">
              ...
              <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => setShowContactInfo(false)}>
                <X className="w-5 h-5" />
              </Button>
            </div>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="https://wa.me/+97250473438" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-[#25D366] text-white px-3 py-1 rounded-full text-sm hover:bg-[#22BF5B] transition-colors">
